...
// BDUVulnerability — запись из локального каталога БДУ ФСТЭК.
//
// Отдельный тип от Vulnerability: тот описывает уязвимость в модели проекта,
// а этот — строку внешнего справочника, которую мы только читаем и не храним
// в Postgres.
