...
// RoadmapOptions — поправки долгосрочного планирования.
//
// Обе выключены по умолчанию: осмысленного значения «по умолчанию» ни у
// ставки приведения, ни у скорости старения защиты нет, а молча менять
// числа, которые оператор уже видел, нельзя.
type RoadmapOptions struct {
	// DiscountRate — годовая ставка приведения затрат. Рубль, потраченный
	// на третий год, дешевле сегодняшнего.
	DiscountRate float64
	// DegradationRate — годовая скорость старения защиты: сигнатуры
	// отстают от новых образцов, правила фильтрации — от новых техник.
	// В отличие от истечения сертификата это экспертное допущение.
