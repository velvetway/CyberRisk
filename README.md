...
- [velvetway/minreestr-mcp](https://github.com/velvetway/minreestr-mcp) — MCP-сервер для поиска по каталогу российского ПО каталогпо.рф (26 000+ продуктов, ФСТЭК/ФСБ-сертифицированное ПО, производители).
- [velvetway/bdu-fstec-mcp](https://github.com/velvetway/bdu-fstec-mcp) — MCP-сервер для БДУ ФСТЭК (86 000+ российских уязвимостей): FTS5-поиск, фильтры по CVSS/опасности/году/вендору, обратный маппинг CVE → БДУ.
- [velvetway/bdu-fstec-mirror](https://github.com/velvetway/bdu-fstec-mirror) — зеркало БДУ ФСТЭК без геоблока (XML + готовая SQLite-база с FTS5-индексом).
